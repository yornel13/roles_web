...
<html>
    ...
    <body>
        ...
        <div  class="container" style="padding-top: 0px">
            ...
            <section>
                <h2 class="content-title">Usuarios</h2>
            </section>

            <div class="container-filter">

                <form class="container-range">
                    <button href="#" name="add" class="next">
            ...
            <div class="table-responsive">
                ...
                <table id="user_table" class="table table-striped table-bordered table-hover">
                    ...
                    <%
                        ...
                        List<User> listaUsuario = (List<User>) request.getAttribute(Const.USERS);
