...
public class RolClienteReport extends HttpServlet{
    ...
    private void mainHeader(Document document){
        ...
        Paragraph reportTitle = new Paragraph("Rol de Pago Cliente.", reportTitleFont);
    ...
    private void descriptionFixedHeader(Document document, String cliente, String numeracion, String lapso){
        ...
        Paragraph clientFullName = new Paragraph("Cliente: "+cliente, clientFont);
        ...
        Paragraph numberRuc = new Paragraph("Numeración: "+numeracion, clientFont);
