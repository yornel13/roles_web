    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="table table-striped table-bordered table-hover" style="max-width: 800px; position: relative;left:0;right:0;margin: auto;">
                ...
                <tbody>
                <tr>
                    <td style="background: white"><%=var%></td>
                </tr>
                </tbody>
            </table>
            <%
            ...
            <div class="table-responsive" style="padding-top: 30px; display: block">
                <button style="background-color: lightgreen; padding: 5px; border-radius: 5px; border: none; overflow: hidden; cursor: auto">
                    RECIBIDO
                </button>
                <button style="background-color: lightcoral; padding: 5px; border-radius: 5px; border: none; overflow: hidden; cursor: auto">
                    RETENIDO
                </button>
            </div>
